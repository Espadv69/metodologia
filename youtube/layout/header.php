...
<html lang="en">
    ...
    <div class="side-menu" id="side-menu">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" style="pointer-events: none; display: inherit; font-size: 13px;" aria-hidden="true">
